    ...
    render() { 
        return (  
            <div className="lab2">
                ...
                <h3>Selecting content with Class and ID selectors </h3>
                <p id="paraSelectedById"> This para was selected and styled by ID</p>
                <p className="paraSelectedByClass"> This para was selected and styled by ClassName</p>
 
                <h2>Selecting content based on the document structure</h2>
                ...
                <h3> Styling the foreground color</h3>
                ...
                <h3>Styling the background color</h3>
                ...
                <a href='#/Labs/A2/Week4'>Go To Labs A2 - Week 4</a>  <br/>
